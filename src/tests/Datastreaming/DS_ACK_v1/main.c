...
Q15 idle_work_data[CDC_PACKET_LEN];

// static void idle_work(Q15 *idle_data);
...
// static void idle_work(Q15 *idle_data){
//     tud_cdc_n_write(CDC_DATA_CHAN, (uint8_t *)idle_data, CDC_PACKET_LEN);
// }
// static int32_t recieve_ack(void){
